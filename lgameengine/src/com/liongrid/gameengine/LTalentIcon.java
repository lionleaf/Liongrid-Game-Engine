...
//TODO: Make generic
public abstract class LTalentIcon extends RadioButton {


	private LUpgrade<?> mUpgrade = null;
	...
	private int mDefaultIcon = R.drawable.icon;
	...
	private void init(AttributeSet attrs){
		...
		try {
			mUpgrade = getUpgradeFromStr(upgradeValue);
		} catch (Exception e) {
	...
	protected abstract LUpgrade getUpgradeFromStr(String upgradeValue);
